...
abstract class EndlessRecyclerViewScrollListener(
        ...
        private val startingPageIndex: Long = 1,
        // The minimum amount of items to have below your current scroll position
        // before loading more.
        private var visibleThreshold: Long = 1,
        // The total number of items in the dataset after the last load
        private var previousTotalItemCount: Long = 0
    ...
    abstract fun onLoadMore(page: Long, totalItemsCount: Long, view: RecyclerView?)
